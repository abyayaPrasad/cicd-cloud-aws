...
NonProdBuildSpec="sc-data-orch/iaac/scripts/buildspec.yml" # Buildspec file name
ResourceTemplate="sc-data-orch/iaac/cloudformation/lambda-function.yml" # Absolute path from repo
